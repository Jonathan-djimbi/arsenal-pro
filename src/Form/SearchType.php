...
class SearchType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) // OUTDATED OLD ?
    {           
        //
        //
        //
        ...
        $builder
            ...
            ->add('submit', SubmitType::class,
                [
                    'label' => 'Filtrer',
                    'attr' => [
                        'class' => 'btn-block btn-success border_radius_all w-75 mx-auto mt-3',
                        'aria-label' => 'filtrer'
                    ]
                ])
        ;
