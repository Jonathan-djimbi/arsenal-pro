...
class RachatArmeCrudController extends AbstractCrudController
{
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, CollectionFilterCollection $filters): QueryBuilder //REQUETE SQL
    {
        ...
        $response->andWhere("entity.type = 'rachat-arme'"); 
    ...
    {
        return $crud
        ->setPageTitle(pageName: 'index', title: "Rachat d'armes")
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            BooleanField::new('isLegit','Autorisé à détenir ?')->setFormTypeOption('disabled','disabled'),
            ImageField::new('photoUn','Première photo')
               ->setBasePath('uploads/rachat-armes/')
               ->setUploadDir('public/uploads/rachat-armes')
