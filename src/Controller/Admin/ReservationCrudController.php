...
class ReservationCrudController extends AbstractCrudController
{
    ...
    {
        return 
        $crud->setPageTitle(pageName: 'index', title: "Location d'armes")
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, CollectionFilterCollection $filters): QueryBuilder //REQUETE SQL
    {
        ...
        $response->andWhere("entity.type = 0"); //pas afficher commandes non payés
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextareaField::new('descriptionUn', 'Usage'),
            TextareaField::new('descriptionDeux', 'Fonctionnement'),
            TextareaField::new('descriptionTrois', 'Particularité'),
            TextareaField::new('descriptionQuatre', 'Avis d’expert'),
